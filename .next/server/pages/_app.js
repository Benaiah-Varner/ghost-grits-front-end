...
const prodEndpoint = `https://ghost-grits-server.herokuapp.com/admin/api`;
...
// CONCATENATED MODULE: ./components/FutureLayout.js


const FutureLayout = external_styled_components_default.a.div.withConfig({
...
function Page({
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(FutureLayout, {
    children: children
  });
}
...
function MyApp({
  ...
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(client_["ApolloProvider"], {
    client: apollo,
    children: /*#__PURE__*/Object(jsx_runtime_["jsx"])(cartState["a" /* CartStateProvider */], {
